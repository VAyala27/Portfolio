var data = [{
    ...
    },
    {
        ...
        code: "https://github.com/VAyala27/moda",
        link: "https://vayala27.github.io/moda/"
    },
    {
        name: "Mova",
        subname: "Landing Page",
        img: "https://s8.gifyu.com/images/adobe_email.gif",
        category: "Landing-Page",
        code: "https://github.com/VAyala27/mova",
        link: "https://vayala27.github.io/mova/"
    },
    {
        name: "Horizons",
        subname: "Landing Page",
        img: "https://s8.gifyu.com/images/adobe_email.gif",
        category: "Landing-Page",
        code: "https://github.com/VAyala27/horizons/",
        link: "https://vayala27.github.io/horizons/"
    }
];
...
$(document).ready(function (e) {
    ...
    $('.filter-btn').on('click', function () {
        $('.filter-btn.tabActive').removeClass('tabActive');
        $(this).addClass('tabActive');

        var listItem = $(this).attr('data-id');

        $('.work-container.active').fadeOut(500, showNext);
...
function displayWork(workItems) {
  ...
  <div class="work-wrap" data-toggle="modal" data-target="#${work.name}" style=" z-index: 0; object-fit: cover; background: url('${work.img}')no-repeat top/cover" data-id="${work.category}">
    <div class="work-links">
      <a href="${work.code}" target="_blank"><i class="fab fa-github"></i></a>
      <a href="${work.link}" target="_blank"><i class="fas fa-link"></i></a>
    </div>
  </div>
